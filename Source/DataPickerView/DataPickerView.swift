...
//        pickerView.clipsToBounds = true
    ...
    func scrollToValue(value: String) {
        pickedValue = value
        if let index = constantValue.countryArray.firstIndex(of: value){
...
extension DataPickerView:UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    public  func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return constantValue.countryArray.count
    }
    
    public func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return constantValue.countryArray[row]
    }
    
    public func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        let setCountryCode = constantValue.countryArray[row]
